...
// SGLD Address & Minimal ABI
const SGLD_ADDRESS = '0x10C5E0643bCc6C915Cad0335f70A96c1532766eb' as `0x${string}`
const sgldAbi = [
  {
    name: 'totalSupply',
    type: 'function',
...
export default function SGLDProductPage({ 
  ...
  useEffect(() => {
    async function fetchOnChainData() {
      try {
        ...
        console.error('Error querying live SGLD supply on Base:', error)
      }
    }
  ...
  const faqs = [
    {
      q: "What is SGLD?",
      a: "Syncrate Gold (SGLD) is a digital asset where each token is fully backed by one troy ounce of 99.99% pure physical gold bullion secured in reputable UAE vaults."
    },
    {
    ...
    },
    {
      ...
      a: "No. There is no minimum minting requirement and SGLD can be redeemed back into USDC/USDT at any amount"
    },
    {
    ...
    },
    {
      ...
      a: "A 0.25% fee is charged on every SGLD redemption transaction."
    }
  ]
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 py-12 md:py-20">
          <div className="flex flex-col text-left max-w-3xl">
            ...
            <p className="text-sm md:text-base text-[#AAAAAA] leading-relaxed mb-8 max-w-xl">
              Backed by 99.99% pure LBMA-standard gold. Each SGLD token representing 1 troy oz of physical bars vaulted securely with reputable custodians in the UAE.
            </p>
                ...
                <div className="relative" ref={infoModalRef}>
                  ...
                  {showInfoModal && (
                    <div className="absolute top-8 right-0 md:left-0 z-50 w-60 md:w-64 p-3 bg-[#111111] border border-[#222222] rounded-lg shadow-2xl text-xs text-[#AAAAAA] leading-relaxed">
                      ...
                      Represents the total physical gold in custody that has not yet been minted onchain as SGLD tokens.
                    </div>
                  )}
                </div>
              </div>
