...
export default function BlogPost() {
        ...
        <div className="bg-[#161616] rounded-[32px] p-6 md:p-10 shadow-2xl">
          ...
          <article className="space-y-6 text-[#D4D4D8] text-base md:text-lg leading-relaxed font-light">
            ...
            <p>
             ...
             Today, SGLD is publicly live on Base. 
            </p>

            <p>
              SGLD is Syncrate’s tokenized gold asset, designed to bring gold onchain as a programmable financial primitive. Each SGLD token represents exposure to one troy ounce of gold held within Syncrate’s custody infrastructure. 
  ...
  With SGLD, gold can now be integrated directly into decentralized finance to:
</p>
...
<ul>
  ...
  <li>Power real-world yield strategies by composing with other DeFi primitives.</li>
               ...
               <h2 className="text-2xl font-normal text-white pt-6 border-t border-[#222222] tracking-tight">
              The Modular Architecture: SGLD and sySGLD
            </h2>
              ...
              <p>
               ...
               <ul>
  <li><strong>Syncrate Gold (SGLD):</strong> Provides direct exposure to tokenized gold.</li>
  <li><strong>Syncrate Prime (sySGLD):</strong> Built on top of SGLD, sySGLD deploys gold-backed capital into real-world financing arrangements to generate yield.</li>
</ul>
              ...
              Why Composability Matters
                ...
                <p>
The launch of SGLD is a major milestone, but it’s only the beginning. As we expand, we are focused on deepening liquidity, scaling DeFi integrations, building institutional partnerships, and driving multichain access.
</p>
