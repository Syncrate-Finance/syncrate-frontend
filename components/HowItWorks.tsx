      ...
      <div className="w-full relative flex flex-col items-center">
        {steps.map((src, index) => (
          <div
            ...
            className="sticky top-[15vh] md:top-[20vh] w-[90%] max-w-lg md:max-w-xl aspect-[1200/1081] rounded-[32px] overflow-hidden border border-[#222222] bg-[#030303] shadow-[0_-15px_40px_rgba(0,0,0,0.8)] mb-[30vh]"
          >
            <Image
              src={src}
              alt={`Step ${index + 1}`}
